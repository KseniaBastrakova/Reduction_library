...
template<>
class attribute::Geting_weighting_power<SOA::Particle_spicies_old, attribute::Scalar_records_names::weighting>
{
public:
    Geting_weighting_power(){}
    double operator() (SOA::Particle_spicies_old particles)
    {
...
template<>
class attribute::Geting_weighting_power<SOA::Particle_spicies_old, attribute::Scalar_records_names::momentum_x>
{
public:
    Geting_weighting_power (){}
    double operator() (SOA::Particle_spicies_old particles)
